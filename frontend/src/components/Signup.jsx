...
import { emailState, nameState, passwordState, roleState } from "../atoms/atoms";
    ...
    <div className="w-8 h-10 bg-green-600 rounded-l-3xl"></div>
        ...
        <div className="flex pl-10 pb-5">
          ...
          <select
            ...
            className="flex-1 h-10 border border-green-600 pl-2 focus:outline-none focus:border-green-600 bg-white text-gray-500"
          >
